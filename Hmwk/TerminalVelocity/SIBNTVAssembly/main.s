...
main:
 ...
 ldr r2, =0x000000C9 @pi: WD 8 BP -6
 ldr r0, =0x00000001 @cd: WD 1 BP -1
 mul r2, r2, r0 @r2 = pi*cd
 
 ldr r0, =0x00000005 @ dd: WD 8 BP -8  (d^2)
 mul r2, r2, r0 @r2 = pi*cd*dd
 
 ldr r0, =0x0000004E @c: WD 15 BP -15
 mul r2, r2, r0 @r2 = pi*cd*dd*c
 ...
 mul r1, r1, r0 @0.5 * v^2
 
 ldr r0, =0x0000004E @ c: WD 15 BP -15
 mul r1, r1, r0 @0.5 * v^2 * c : WD 32 BP -14
 lsr r1, #14 @q : WD 32
